...
- На коммутаторе S2 порты Fa0/1 и Fa0/2 смотрят в Root Bridge, стоимости путей до корневого моста равны, BID отправителя одинаков, но приоритет порта отправителя Fa0/1 меньше чем у Fa0/2. (128.1<128.2)
- На коммутаторе S3 порты Fa0/3 и Fa0/4 смотрят в Root Bridge, стоимости путей до корневого моста равны, BID отправителя одинаков, но приоритет порта отправителя Fa0/3 меньше чем у Fa0/4. (128.3<128.4)
