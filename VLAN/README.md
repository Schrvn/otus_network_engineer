...
1. Измените режим порта коммутатора на интерфейсе F0/1 для принудительного транкинга. Обязательно сделайте это на обоих коммутаторах.
2. В рамках конфигурации транка установите собственный VLAN на 8 на обоих коммутаторах. Вы можете временно увидеть сообщения об ошибках, пока два интерфейса настроены для разных собственных VLAN.
2. В качестве другой части конфигурации транка укажите, что VLAN 3, 4 и 8 разрешено пересекать транк.
3. Выполните команду show interfaces trunk для проверки портов транкинга, собственного VLAN и разрешенных VLAN через транк.
